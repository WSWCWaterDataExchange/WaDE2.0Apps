...
ui <- dashboardPage(
  title = "Aggregated Budget Dashboard Demo",
      ...
      box(
        ...
        <html>
          ...
          <body>
            ...
            <div class='col-md-9'>
              <h1 style='text-align:center'; class='parallax'><strong>DEMO:</strong> WestDAAT <span style=color:purple><b>Aggregated Area Water Budget</b></span> Time Series Data</h1>
