...
CountySF <- readOGR(dsn = "data", layer = "P_WaDECounties")
HUCSF <- readOGR(dsn = "data", layer = "P_WaDEHUC8")
CustomSF <- readOGR(dsn = "data", layer = "P_Custom")
DAUCOSF <- readOGR(dsn = "data", layer = "P_Custom_B")
HydrologicRegionSF <- readOGR(dsn = "data", layer = "P_Custom_C")
...
#DAUCOSF
names(DAUCOSF@data)[names(DAUCOSF@data)=="TypeNameNu"] <- "TypeNameNum"
names(DAUCOSF@data)[names(DAUCOSF@data)=="ReportingU"] <- "ReportingUnitID"
names(DAUCOSF@data)[names(DAUCOSF@data)=="Reportin_1"] <- "ReportingUnitUUID"
names(DAUCOSF@data)[names(DAUCOSF@data)=="Reportin_2"] <- "ReportingUnitNativeID"
names(DAUCOSF@data)[names(DAUCOSF@data)=="Reportin_3"] <- "ReportingUnitName"
names(DAUCOSF@data)[names(DAUCOSF@data)=="Reportin_4"] <- "ReportingUnitTypeCV"
names(DAUCOSF@data)[names(DAUCOSF@data)=="Reportin_5"] <- "ReportingUnitUpdateDate"
names(DAUCOSF@data)[names(DAUCOSF@data)=="Reportin_6"] <- "ReportingUnitProductVersion"

#HydrologicRegionSF
names(HydrologicRegionSF@data)[names(HydrologicRegionSF@data)=="TypeNameNu"] <- "TypeNameNum"
names(HydrologicRegionSF@data)[names(HydrologicRegionSF@data)=="ReportingU"] <- "ReportingUnitID"
names(HydrologicRegionSF@data)[names(HydrologicRegionSF@data)=="Reportin_1"] <- "ReportingUnitUUID"
names(HydrologicRegionSF@data)[names(HydrologicRegionSF@data)=="Reportin_2"] <- "ReportingUnitNativeID"
names(HydrologicRegionSF@data)[names(HydrologicRegionSF@data)=="Reportin_3"] <- "ReportingUnitName"
names(HydrologicRegionSF@data)[names(HydrologicRegionSF@data)=="Reportin_4"] <- "ReportingUnitTypeCV"
names(HydrologicRegionSF@data)[names(HydrologicRegionSF@data)=="Reportin_5"] <- "ReportingUnitUpdateDate"
names(HydrologicRegionSF@data)[names(HydrologicRegionSF@data)=="Reportin_6"] <- "ReportingUnitProductVersion"
