...
# Date: 04/28/2020
# Topic: 1) Practice creating a shiny app.
#        2) Testing large allocations data.
...
#######  Custom Lists ####### 
BenUseList <- c("Select All", "Agricultural", "Commercial", "Domestic", "Fire", "Industrial", "Mining", "Municipal", 
...
StateList <- c("Select All", "NM", "CA", "CO", "ID", "WA", "OR", "UT", "AZ", "OK", "ND")
...
FileIn$secondLocationID <- paste(as.character(FileIn$AA_ID), "_selectedLayer", sep="")
coordinates <- SpatialPointsDataFrame(FileIn[,c('Long', 'Lat')] , FileIn)
