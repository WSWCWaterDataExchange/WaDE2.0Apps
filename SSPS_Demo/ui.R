      ...
      box(
        ...
        <html>
          ...
          <body>
            ...
            <div class='col-md-9'>
              <h1 style='text-align:center'; class='parallax'><strong>DEMO:</strong> WestDAAT Site-Specific <span style=color:blue><b>Public Supply Water</b></span> Time Series Data</h1>
              <p style='text-align:center'; class='parallax_description'>A web tool used to visualize and query historic water data for places of use and points of diversions and their relationships across the Western United States.</p>
